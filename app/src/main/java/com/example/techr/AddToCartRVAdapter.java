...
public class AddToCartRVAdapter extends RecyclerView.Adapter<AddToCartRVAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public AddToCartRVAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AddToCartRVAdapter.ViewHolder holder, int pos){
