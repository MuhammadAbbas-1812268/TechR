...
public class BrowseProductsAdmin extends AppCompatActivity implements ProductRVAdapter.ProductClickInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_browse_products_admin);
        ...
        addFAB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(BrowseProductsAdmin.this,AddProduct.class));
            }
        });
        getAllProducts();
    ...
    public void getAllProducts(){
        ...
        db.collection("Products").get()
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(BrowseProductsAdmin.this, "Something went wrong", Toast.LENGTH_SHORT).show();
            }
        });
                ...
                CartList.set(map)
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                Toast.makeText(BrowseProductsAdmin.this, "Add To Cart Successful", Toast.LENGTH_SHORT).show();
                                Bundle bundle = new Bundle();
                                Intent i = new Intent(BrowseProductsAdmin.this,AddToCart.class);
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(BrowseProductsAdmin.this, "Failed to Add Product", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
